//! 얼음낚시 — 이 앱에서 가장 긴 동작(30~60초)이고 **안에서 갈래가 갈리는 첫 동작**이다.
//!
//! 국면 여섯(구멍 뚫기·드리우기·입질·잡음·꽝·정리)을 돌고, 잡아도 다시 드리운다 —
//! **판을 끝내는 것은 예산뿐이다.** 잡으면 끝내게 했더니 중앙값이 18.6초로 내려가
//! 졸기보다 짧아졌다.
//!
//! 국면과 잡음/꽝은 **코어가 정한다.** "무슨 동작"이라 웹뷰가 뽑으면 같은 시드가
//! 같은 결과를 내지 않는다 (PRINCIPLE 3).
//!
//! 예산은 절대 시각 하나로 갖고 **드리우기에 들어갈 때만** 확인한다. 국면 도중에
//! 자르면 낚싯대를 든 채 사라지거나 채는 동작이 반쯤에서 잘린다.
//!
//! 헤엄치는 중에 시키면 **허공에서** 낚시한다 — 고도를 그대로 물려받는다.
